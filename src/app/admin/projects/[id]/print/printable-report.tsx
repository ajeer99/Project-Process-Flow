...
import { ShieldCheck, Bug, Activity, CheckCircle2, Trophy, Clock, FileText } from 'lucide-react';
import { UserAvatar } from '../../../components/user-avatar';
import { format, subDays, isAfter } from 'date-fns';
import { PrintControls } from '../../../components/print-controls';
import { PieChart, Pie, Cell, ResponsiveContainer, Tooltip as RechartsTooltip, Legend, BarChart, Bar, XAxis, YAxis, CartesianGrid } from 'recharts';

export function PrintableReport({ project }: { project: any }) {
    // 1. Core Metrics
    ...
    // Removed auto-print script based on user preference and replaced with explicit PrintControls

    const pageClasses = "mx-auto bg-white p-8 print:p-0 print:max-w-none print:w-full min-h-[210mm] max-w-[297mm] shadow-lg print:shadow-none text-slate-900";
    ...
    return (
        <div className="bg-slate-100 min-h-screen py-8 print:py-0 print:bg-white print:w-full print:m-0">
            ...
            <div className={`${pageClasses} print:break-after-page`}>
                ...
                <div className="border-b-2 border-slate-900 pb-6 mb-8 flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-slate-600 mt-2 max-w-2xl">{project.description || 'Comprehensive analysis and audit of project lifecycle.'}</p>
                    </div>
            ...
            {/* Page 2 onwards: Audit Log */}
            <div className={`${pageClasses} print:break-inside-avoid print:pt-8`}>
                <div className="border-b-2 border-slate-900 pb-4 mb-6 flex items-center gap-3">
                    <FileText className="w-6 h-6 text-slate-800" />
                    <h2 className="text-2xl font-bold text-slate-900">Complete Issue Audit Log</h2>
                </div>
            ...
            {/* Global Print Styles to enforce A4 size and hide browser headers if possible */}
            <style jsx global>{`
                @media print {
                    @page {
                        size: A4 landscape;
                    ...
                    /* Ensure background colors are printed for charts and headers */
                    * {
